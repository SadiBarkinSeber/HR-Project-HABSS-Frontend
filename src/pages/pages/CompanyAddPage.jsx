...
const CompanyAddPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!validateMersisNo(companyData.mersisNo)) {
      toast.warning(
        "Girdiğiniz Mersis No sadece rakamlardan oluşmalı ve 16 hane uzunluğunda olmalıdır."
      );
      return;
    }
    if (!validateTaxNumber(companyData.taxNumber)) {
      toast.warning(
        "Girdiğiniz Vergi No sadece rakamlardan oluşmalı ve 10 hane uzunluğunda olmalıdır."
      );
      return;
    }
    ...
    if (
      !validateContractDates(companyData.dealStartDate, companyData.dealEndDate)
    ) {
      toast.warning(
        "Sözleşme başlangıç tarihi sözleşme bitiş tarihinden önce veya aynı olamaz."
      );
      return;
    }
    try {
            ...
            <div className="card-body">
              ...
              <div className="mb-3">
                <label htmlFor="mersisNo">
                  Mersis No: <span className="text-danger">*</span>
                </label>
                <input
                  type="text"
                  id="mersisNo"
              ...
              <div className="mb-3">
                <label htmlFor="taxNumber">
                  Vergi No: <span className="text-danger">*</span>
                </label>
                <input
                  type="text"
                  id="taxNumber"
              ...
              <div className="mb-3">
                <label htmlFor="taxDepartment">
                  Vergi Dairesi: <span className="text-danger">*</span>
                </label>
                <input
                  type="text"
                  id="taxDepartment"
            ...
            <div className="card-body">
              ...
              <div className="mb-3">
                <label htmlFor="employeeCount">
                  Çalışan Sayısı: <span className="text-danger">*</span>
                </label>
                <input
                  type="number"
                  id="employeeCount"
              ...
              <div className="mb-3">
                <label htmlFor="foundingDate">
                  Kuruluş Tarihi: <span className="text-danger">*</span>
                </label>
                <input
                  type="date"
                  id="foundingDate"
              ...
              <div className="mb-3">
                <label htmlFor="dealEndDate">
                  Sözleşme Bitiş Tarihi: <span className="text-danger">*</span>
                </label>
                <input
                  type="date"
                  id="dealEndDate"
