...
// export const ManagerPersonalUpdate = (props) => {
//   const {
//     firstName,
//     secondName,
//     firstSurname,
...
// const handleDetailButton = () => {
//   navigateTo("/mng-detail");
// };

// return (
//   <>
//     <div className={styles.managerSumCard}>
//       <div>
//         <label htmlFor="">Mail :</label>{" "}
//         <input
//           className="form-control"
...
// export const ManagerCardLeftSide = (props) => {
// const navigateTo = useNavigate();
// const { setProfilePictureData, profilePictureData } = useProfilePicture();

// const handleUpdateButton = () => {
//   navigateTo("/mng-update");
// };
...
// export const ManagerUpdateCardLeftSide = (props) => {
// const { setProfilePictureData, profilePictureData } = useProfilePicture();
...
// );
// };
// export const ManagerPersonalDetail = (props) => {
// const {
//   firstName,
//   secondName,
//   firstSurname,
...
// export const ManagerJobDetail = (props) => {
// const { startDate, endDate, isActive, position, department, company, wage } =
//   props;
